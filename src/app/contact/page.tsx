              ...
              <div className="lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                  ...
                  <p className="flex items-start -mx-2">
                    ...
                    <a
                      href="mailto:info@oxygenict.com"
                      className="mx-2 text-gray-700 truncate w-72"
                    >
                      info@oxygenict.com
                    </a>
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg glass-card lg:max-w-xl">
                  ...
                  <form className="mt-6">
                    ...
                    <button className="primary-btn w-full mt-6 shade-x z-10">
                      get in touch
                    </button>
                  </form>
                </div>
