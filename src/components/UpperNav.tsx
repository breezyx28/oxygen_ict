        ...
        <div className="upper-menu">
          <ul className="flex gap-x-10">
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/"} replace>
                Home
              </Link>
            </li>
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/services"}>
                Services
              </Link>
            </li>
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/about"}>
                About Us
              </Link>
            </li>
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/history"}>
                Our History
              </Link>
            </li>
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/achievements"}>
                Achievments
              </Link>
            </li>
            <li className="text-slate-500 hover:text-slate-800 duration-100 ease-in font-semibold">
              <Link className="upper-nav-link" href={"/events"}>
                Events
              </Link>
            </li>
          </ul>
        </div>
        <Link href={"/contact"} className="primary-btn shade-x">
          Contact Us
        </Link>
      </div>
